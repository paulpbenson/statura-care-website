...
const footerLinks = {
  ...
  Resources: [
    ...
    { label: "Aged Care Act 2024 Guide", href: "/aged-care-act-2024" },
    { label: "SIRS Checklist", href: "/resources/sirs-checklist" },
    { label: "Audit Preparation Guide", href: "/resources/audit-preparation-guide" },
